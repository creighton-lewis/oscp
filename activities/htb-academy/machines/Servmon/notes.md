...
```
vulnx search {program name}
- searched for cve that was disclosed in thes ame year that this machine was created
- copied to system 
```
...
- initially, comamnds were not working. but when i switched to powershell, they started to 
